...
public class LerpBasics : MonoBehaviour
{
    ...
    private void UpdatePositionTracking()
    {
        ...
        {
            transform.position = 
                Vector3.Lerp(transform.position, targetTransform.position, positionLerpSpeed * Time.deltaTime);
        }

        else
        {
            transform.position = 
                Vector3.MoveTowards(transform.position, targetTransform.position, positionLerpSpeed * Time.deltaTime);
        }
    }
